package com.tehila.coupons.filters;
...
public class LoginFilter implements Filter {
    ...
    private boolean isRequestAWhitelisted(String methodType, String url) {
        ...
        if (methodType.equals("get") && url.endsWith("/coupons/byCompanyId")){
            return true;
        }
        if (methodType.equals("get") && url.endsWith("/coupons/byCategoryId")){
            return true;
        }
        if (methodType.equals("get") && url.endsWith("/coupons/upToGivenPrice")){
            return true;
        }
        ...
        if (methodType.equals("get") && url.matches(".*/categories/\\d+$")) {
            return true;
        }

        if (methodType.equals("get") && url.matches(".*/companies/\\d+$")) {
            return true;
        }
